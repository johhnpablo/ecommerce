    ...
    <div class="flex flex-col gap-4 md:gap-0 md:flex-row w-full justify-between px-8 md:px-24 py-6  pb-12 border-b border-solid border-gray-500  ">
        ...
        <div class="flex flex-col w-full gap-6 md:gap-4">
            ...
            <div class="flex flex-row w-full gap-4">
                <img class="w-6" src="{{ Vite::images('facebook.png') }}" >
                <img class="w-6" src="{{ Vite::images('linkedin.png') }}" >
                <img class="w-6" src="{{ Vite::images('instagram.png') }}" >
                <img class="w-6" src="{{ Vite::images('twitter.png') }}" >
            </div>
            <div class="flex flex-row w-full gap-4">
                <img class="w-36" src="{{ Vite::images('apple.svg') }}" >
                <img class="w-36" src="{{ Vite::images('apple.svg') }}" >
            </div>
        </div>
    </div>
    <span class="text-title-5 font-light text-gray-600 my-4">All Right Reserverd - John Pablo</span>
</div>
